...
export default async function WebPage() {
  ...
  // Use web apps, or fall back to general apps if web category has few items
  ...
  // Curated lists for Web layout (matching /apps style)
