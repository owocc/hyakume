      ...
      {allApps.length === 0 ? (
        <div className="bg-surface rounded-3xl p-10 md:p-14 border border-border text-center space-y-6 shadow-sm">
          ...
          <div className="pt-2">
            <Link
              href="/recommend"
              className="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-black hover:bg-neutral-800 text-white font-bold text-sm shadow-md transition-all hover:shadow-lg hover:scale-105"
            >
